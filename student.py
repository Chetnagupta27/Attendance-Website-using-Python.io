...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"C:\Users\pc\Desktop\Face Recognition\college_images\face-recognition.png")
        ...
        #second image
        img1=Image.open(r"C:\Users\pc\Desktop\Face Recognition\college_images\gettyimages-1022573162.jpg")
        ...
        #third image
        img2=Image.open(r"C:\Users\pc\Desktop\Face Recognition\college_images\iStock-182059956_18390_t12.jpg")
        ...
        title_lbl=Label(bg_img,text="STUDENT MANAGEMENT SYSTEM",font=("times now roman",35,"bold"),bg="white",fg="darkgreen")
        ...
        img_left=Image.open(r"C:\Users\pc\Desktop\Face Recognition\college_images\AdobeStock_303989091.jpeg")
       ...
       #current course 
        current_course_frame=LabelFrame(main_frame,bd=2,relief=RIDGE,text="Correct course information",font=("times new roman",12,"bold"))
        current_course_frame.place(x=9,y=135,width=730,height=150)
        ...
        dep_combo["values"]=("Select Department","computer","civil","IT","Mechanical")
        dep_combo.current(0)
        ...
        class_Student_frame.place(x=9,y=250,width=730,height=315)

        #studentId
        studentId_label=Label(class_Student_frame,text="StudentID:",font=("times new roman",12,"bold"),bg="white")
        studentId_label.grid(row=0,column=0,padx=10,sticky=W)

        student_entry=Entry(class_Student_frame,textvariable=self.var_std_id,width=20,font=("times new roman",13,"bold"))
        ...
        studentName_entry=ttk.Entry(class_Student_frame,textvariable=self.var_std_names,width=20,font=("times new roman",13,"bold"))
        ...
        btn_frame.place(x=0,y=215,width=730,height=80)
        ...
        btn_frame1.place(x=0,y=245,width=735,height=35)
        take_photo_btn=Button(btn_frame1,text="Take Photo Sample",width=37,font=("times new roman",13,"bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"C:\Users\pc\Desktop\Face Recognition\college_images\students.jfif")
        ...
        Search_frame.place(x=9,y=140,width=708,height=70)
        ...
        table_frame.place(x=9,y=210,width=710,height=350)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="12345678",database="face_recognizer")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,Year=%s,Semester=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Teacher=%s,PhotoSample=%s where Student_id=%s",(
